...
func main() {
	...
	//fmt.Scanln()
	flow.CreateAccount("NonFungibleToken", "DemoToken", "Art", "Auction", "Versus")
	flow.AddContract("NonFungibleToken", "NonFungibleToken")
	flow.AddContract("NonFungibleToken", "DemoToken")
	flow.AddContract("NonFungibleToken", "Art")
	flow.AddContract("NonFungibleToken", "Auction")
	flow.AddContract("NonFungibleToken", "Versus")
