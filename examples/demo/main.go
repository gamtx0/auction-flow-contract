...
func main() {
	g := gwtf.
		...
		CreateAccount("accounts", "marketplace", "artist", "buyer1", "buyer2")

	g.AddContract("accounts", "NonFungibleToken")
	g.AddContract("accounts", "DemoToken")
	g.AddContract("accounts", "Art")
	g.AddContract("accounts", "Auction")
	g.AddContract("accounts", "Versus")
	...
	fmt.Scanln()
	g.TransactionFromFile("setup/actor").SignProposeAndPayAs("marketplace").UFix64Argument("0.0").RunPrintEventsFull()
